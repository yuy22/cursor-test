# -*- coding: utf-8 -*-
"""
俞正强《低头找幸福》OCR DOCX → Markdown 数据清洗
基于 clean_docx_v2.py，针对本书路径和标题定制
"""
...
# 图片分类阈值
TINY_AREA    = 2000   # <2000px² 直接删
SMALL_AREA   = 5000   # <5000px² 大概率碎片
WHITE_THRESH = 230    # 平均亮度>230 判定为空白/水印
...
NOISE_PATTERNS = [
    ...
    re.compile(r'^\d{1,4}$'),                              # 纯页码
    re.compile(r'^[A-Z\s]{10,}$'),                         # 全大写拼音
    ...
    re.compile(r'更多教学好书请加微信'),           # 广告水印
    re.compile(r'扫码关注'),                        # 二维码广告
